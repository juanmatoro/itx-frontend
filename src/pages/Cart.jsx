...
export default function ProductDetailsPage() {
  ...
  const handleAdd = () => {
    if (!product || !color || !storage) return; // Añadida validación extra
  ...
  }; // Eliminada función flecha redundante
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <h2 className="text-2xl font-bold mb-2">
            {product.brand}&nbsp;{product.model} {/* Quitados labels internos */}
          </h2>
          ...
          <button
            ...
            // Añadido: Estilos focus y active
